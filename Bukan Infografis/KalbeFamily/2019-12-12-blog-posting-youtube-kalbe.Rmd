...
Kita bisa melihat bahwa _Youtube channel_ __KalbeFamily__ berdiri sejak `2013-02-26`. Sampai saat ini, memiliki `77` buah video dan telah dilihat sebanyak `1.101.596` kali. _Channel_ ini memiliki _subscriber_ sebanyak `1.230`.
