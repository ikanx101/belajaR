...
Sekarang kita akan hitung jarak terpendek dari _matrix_ tersebut dengan algoritma __TSP__. Didapatkan metode yang berhasil mendapatkan rute yang paling pendek adalah `arbitrary_insertion+two_opt` dengan jarak total sebagai berikut:
