...
data = read.csv('OHAMMADR2186_1902566878.CSV',skip=4)
saldo_awal = 13495.26
...
chart_1 = 
  ...
  theme_minimal() +
  labs(title='Laporan Akhir Saldo Urunan',
       subtitle='SMAN 1 Bekasi - 2004',
       caption='last update: 12 Jan 2020 04:53',
       color='Tanggal:') +
...
chart_2 = 
  ...
  mutate(tanggal=factor(tanggal,levels = c('8 Jan','9 Jan','10 Jan','11&12 Jan'))) %>%
