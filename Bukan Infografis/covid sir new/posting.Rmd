...
Model kali ini memberikan gambaran bahwa orang yang sakit akan mencapai _peak position_ di sekitar `40%` populasi. 

> Tapi perlu diperhatikan bahwa semua orang sehat akan terinfeksi pada akhirnya dan menjadi resisten.
