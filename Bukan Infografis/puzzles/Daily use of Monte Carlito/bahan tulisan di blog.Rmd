...
> Berdasarkan data yang saya punya dari __AC Nielsen__, proporsi __horang kayah__ di kota tersebut ada sebesar `16%` dari populasi kota tersebut.

Pertanyaannya:

Jika pemilihan respondenn dilakukan secara _random_, berapa banyak orang responden yang harus saya temui sampai saya bisa mendapatkan `30` orang responden __horang kayah__ tersebut?
...
Setidaknya saya membutuh sekitar `187` orang responden agar saya bisa mendapatkan `30` orang responden __horang kayah__.

### Sekarang kita selesaikan dengan simulasi:

> Kenapa sih harus diselesaikan dengan simulasi?

Kadang simulasi dibutuhkan karena kita ingin mendapatkan jawaban berupa selang atau rentang karena kita berhadapan dengan masalah peluang di sini. Sedangkan jawaban `187.5` adalah jawaban eksak.
...
Sekarang, _expected value_ dari simulasi ini adalah sebesar:
