...
_Expected value_ untuk `berapa_hari` _interviewer_ bisa menyelesaikan wawancara ini adalah `r round(mean(hasil$berapa_hari),2)` hari alias `r round(mean(hasil$berapa_hari)/7,2)` minggu.
...
File `csv` hasil simulasi bisa diunduh di sini