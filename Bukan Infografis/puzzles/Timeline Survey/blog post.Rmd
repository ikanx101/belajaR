...
Contohnya, dalam sekali iterasi untuk memenuhi minimal responden, dibutuhkan calon responden sebanyak __`r berapa_calon_responden()`__.

Nah, sekarang kita bikin deh simulasinya dalam `500`-an iterasi.

```{r}
# simulasi dimulai dari mari
hasil = data.frame(id = c(1:2)) # untuk keperluan blog ini, saya set di dua dulu. Data hasil simulasi 500 kali ada di github yah
