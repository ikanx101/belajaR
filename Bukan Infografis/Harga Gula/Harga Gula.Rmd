...
Kita hanya akan membuat model berdasarkan data `Januari 2017` hingga `Desember 2019` sedangkan data pada tahun `2020` akan digunakan untuk validasi model _forecast_.
...
train_data = train_data %>% pad(start_val = lubridate::mdy('1/1/2017'),
                                end_val = lubridate::mdy('12/31/2019'))
