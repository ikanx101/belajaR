---
title: "Korelasi"
subtitle: "Statistika 101"
author: "ikanx101.github.io"
date: "Agustus 5, 2020"
fontsize: 10pt
header-includes:
- \usepackage{titling}
- \pretitle{\begin{center}\includegraphics[width=5in,height=5in]{korelasi.png}\LARGE\\}
- \posttitle{\end{center}}
- \usepackage{fancyhdr}
- \pagestyle{fancy}
- \fancyhead[CO,CE]{ikanx101.github.io}
- \fancyfoot[CO,CE]{Materi Korelasi}
...
knitr::include_graphics('korelasi.png')
```
