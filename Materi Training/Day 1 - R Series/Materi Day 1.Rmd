...
Digunakan untuk melakukan _sort_ pada data dengan menggunakan _piping_.

```{r}
# kita akan sort berdasarkan angka tardines tersebut
# descending
data %>% filter(tardines.frequency>10, bulan == 'Jan') %>% arrange(desc(tardines.frequency))

# ascending
data %>% filter(tardines.frequency>10, bulan == 'Jan') %>% arrange(tardines.frequency)
```
