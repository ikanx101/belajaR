...
- \pagestyle{fancy}
- \fancyhead[CO,CE]{R}
- \fancyfoot[CO,CE]{ikanx101.github.io}
...
__Bayangkan Anda berada di restoran _all you can eat_ dimana semua makanan yang Anda mau ada semua di sana... Ikang__
...
rm(list=ls())
library(readxl)
data = read_excel('/home/ikanx101githubio/Documents/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/COVID.xlsx')
...
```{r, include=FALSE}
rm(list=ls())
data = read_excel('/home/ikanx101githubio/Documents/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/Contoh data non tabular.xlsx')
```
...
```{r,echo=FALSE}
load('/home/ikanx101githubio/Documents/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/r3.rda')
...
rm(list=ls())
data = 
  read.csv('/home/ikanx101githubio/Documents/belajaR/Materi Training/Replikasi GIZ/latihan regresi.csv') %>% 
  mutate(X = NULL)
```
...
```{r,include=FALSE}
rm(list=ls())
data = read_excel('/home/ikanx101githubio/Documents/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/vendor.xlsx')
```
...
```{r,include=FALSE}
rm(list=ls())
data = read_excel('/home/ikanx101githubio/Documents/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/premier league top 60.xlsx')
```
...
Bagaimana cara membuat visualisasi yang bisa melibatkan sebanyak-banyaknya variabel pada data tersebut?
