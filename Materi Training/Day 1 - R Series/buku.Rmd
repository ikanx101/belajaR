...
nomnoml::nomnoml('[Iterasi|
                 ...
                 [Iterasi] -> [nilai korelasi\nterbaik]
                 [nilai korelasi\nterbaik] -> [hitung R squared|Menentukan goodness\nof fit model]')
```

Untuk memudahkan, saya akan menggunakan perhitungan korelasi _Spearman_. Berikut adalah algoritmanya:
