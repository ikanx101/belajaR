...
subtitle: "Sebuah Modul Training"
author: "ikanx101.com"
...
rm(list=ls())
setwd("~/belajaR/Materi Training/Day 1 - R Series")
library(dplyr)
library(tidyr)
library(ggrepel)
```
...
rm(list=ls())
library(readxl)
data = read_excel('~/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/COVID.xlsx')
...
```{r, include=FALSE}
rm(list=ls())
data = read_excel('~/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/Contoh data non tabular.xlsx')
```
...
```{r,echo=FALSE}
load('~/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/r3.rda')
...
rm(list=ls())
data = 
  read.csv('~/belajaR/Materi Training/Replikasi GIZ/latihan regresi.csv') %>% 
  mutate(X = NULL)
```
...
```{r,include=FALSE}
rm(list=ls())
data = read_excel('~/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/vendor.xlsx')
```
...
```{r,include=FALSE}
rm(list=ls())
data = read_excel('~/belajaR/Materi Training/Day 1 - R Series/Data Utk Buku/premier league top 60.xlsx')
```
