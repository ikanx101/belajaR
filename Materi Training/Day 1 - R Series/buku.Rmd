...
Sebagai contoh, jika saya _scrape_ halaman pertama, hasilnya seperti ini:
...
knitr::kable(head(ertiga.data,10),caption = 'Hasil Scrape Ertiga')
```
...
Data ini bisa kalian dapatkan di link berikut dalam format `.rda`.
____
